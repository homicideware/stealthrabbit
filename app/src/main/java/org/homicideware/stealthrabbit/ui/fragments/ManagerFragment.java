...
import org.homicideware.stealthrabbit.databinding.ManagerDialogBackupBinding;
import org.homicideware.stealthrabbit.databinding.ManagerDialogInstallBusyboxBinding;
import org.homicideware.stealthrabbit.databinding.ManagerDialogRepositoryBinding;
import org.homicideware.stealthrabbit.databinding.ManagerDialogRestoreBinding;
import org.homicideware.stealthrabbit.databinding.ManagerDialogSettingsSecurityBinding;
import org.homicideware.stealthrabbit.databinding.ManagerFragmentBinding;
import org.homicideware.stealthrabbit.ui.activities.MainActivity;
import org.homicideware.stealthrabbit.utils.DownloadChroot;
import org.homicideware.stealthrabbit.utils.SRRepo;
...
public class ManagerFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.edit_chroot_folder:
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(activity, R.layout.sr_spinner_item, chroots);
    ...
    private void securitySettings() {
        ...
        binding1.hostname.setText(prefs.getString("hostname", "sr"));
            ...
            if (MainActivity.isBusyboxInstalled()) {
                ...
                r.setOnClickListener(view1 -> {
                    ...
                    binding1.input.setText(prefs.getString(
                            "chroot_prev_repository", context.getResources().getString(R.string.sr_repository)));
                    ...
                    binding1.inputLayout.setEndIconOnClickListener(v -> executor.execute(() -> {
                        try {
                            ...
                            if (!SRRepo.setRepo(repo))
                                throw new JSONException("Bad StealthRabbit repository.");
                            ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(), R.layout.sr_spinner_item, SRRepo.getMainKeys());
                    ...
                    ad2.setOnShowListener(dialog -> {
                        ...
                        download.setOnClickListener(v -> {
                            ...
                            try {
                                String chroot_string = SRRepo.getKeyData(Integer.toString(position[0]));
    ...
    private void showBanner() {
        ...
        }.exec(PathsUtil.APP_SCRIPTS_PATH + "/srbanner", binding.report);
    }
