...
import org.homicideware.stealthrabbit.ui.fragments.HomeFragment;
import org.homicideware.stealthrabbit.ui.fragments.ManagerFragment;
import org.homicideware.stealthrabbit.ui.fragments.MenuFragment;
...
public class MainActivity extends ThemedActivity {
    ...
    private void installOrUpdate() {
        ...
        if (prefs.getString("chroot_backup_path", null) == null) {
            prefs.edit()
                    .putString("chroot_backup_path", PathsUtil.SD_PATH + "/sr-backup.tar.gz")
                    .apply();
        }
        if (prefs.getString("chroot_restore_path", null) == null) {
            prefs.edit()
                    .putString("chroot_restore_path", PathsUtil.SD_PATH + "/sr-backup.tar.gz")
                    .apply();
        }
