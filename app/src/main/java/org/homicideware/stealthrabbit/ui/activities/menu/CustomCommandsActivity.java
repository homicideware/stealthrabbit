...
import org.homicideware.stealthrabbit.SQL.CustomCommandsSQL;
import org.homicideware.stealthrabbit.adapters.CustomCommandsRecyclerViewAdapter;
import org.homicideware.stealthrabbit.databinding.CustomCommandsActivityBinding;
import org.homicideware.stealthrabbit.databinding.CustomCommandsDialogAddBinding;
import org.homicideware.stealthrabbit.databinding.DialogMoveBinding;
import org.homicideware.stealthrabbit.databinding.InputDialogBinding;
...
import org.homicideware.stealthrabbit.utils.BottomNavigationCardBehavior;
import org.homicideware.stealthrabbit.utils.FABBehavior;
import org.homicideware.stealthrabbit.utils.PathsUtil;
import org.homicideware.stealthrabbit.viewdata.CustomCommandsData;
import org.homicideware.stealthrabbit.viewmodels.CustomCommandsViewModel;
...
public class CustomCommandsActivity extends ThemedActivity {
    ...
    private void addItem() {
        binding.add.setOnClickListener(v -> {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<>(activity, R.layout.sr_spinner_item,
                    getResources().getStringArray(R.array.custom_commands_send_to_array));
            ArrayAdapter<String> adapter1 = new ArrayAdapter<>(activity, R.layout.sr_spinner_item,
