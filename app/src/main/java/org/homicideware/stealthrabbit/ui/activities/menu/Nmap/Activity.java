package org.homicideware.stealthrabbit.ui.activities.menu.Nmap;
...
import org.homicideware.stealthrabbit.databinding.NmapActivityBinding;
...
public class Activity extends ThemedActivity {
    ...
    private void loadInterfaces() {
        executor.execute(() -> {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.sr_spinner_item, interfaces);
